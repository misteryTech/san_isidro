...
$stmt = $conn->prepare("
    SELECT dba.*, ut.first_name, ut.last_name, ut.birth_date, ut.civil_status,
                        ...
                        <?php if ($result->num_rows > 0): ?>
                            ...
                            <?php while ($row = $result->fetch_assoc()): ?>
                                ...
                                <tr>
                                 ...
                                 <td>
                                     <button class="btn btn-success btn-sm me-1" data-bs-toggle="modal" data-bs-target="#cashlessModal<?= $counter; ?>">
